        ...
        <div id="content" class="fl-right">
            <div class="section" id="title-page">
                <div class="clearfix">
                    ...
                    <a href="?mod=posts&controller=post&action=addPost" title="" id="add-new" class="fl-left">Thêm mới</a>
                </div>
            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="clearfix">
                                                <div class="tb-title fl-left">
                                                    <a href="?mod=posts&controller=post&action=detail&id=<?php echo $post['post_id'] ?>" title=""><?php echo $post['post_title'] ?></a>
                                                </div>
                                            ...
                                            <td><span class="tbody-text"><?php echo get_post_cat_by_id($post['id_parent']) ?></span></td>
                                            <td><span class="tbody-text"><?php echo $post['status'] ?></span></td>
                                            <td><span class="tbody-text"><?php echo $post['created_by'] ?></span></td>
                                            <td><span class="tbody-text"><?php echo date("d/m/Y H:i:s",$post['created_at'])  ?></span></td>
                                        </tr>
                                <?php
                                    }
                                } ?>
