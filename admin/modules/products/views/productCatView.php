        ...
        <div id="content" class="fl-right">
            <div class="section" id="title-page">
                <div class="clearfix">
                    ...
                    <a href="?mod=products&controller=productCat&action=add" title="" id="add-new" class="fl-left">Thêm mới</a>
                </div>
            </div>
                        ...
                        <table class="table list-table-wp">
                            ...
                            <tbody>
                                ...
                                ?>
                                            <tr>
                                                ...
                                                <td class="clearfix">
                                                    <div class="tb-title fl-left">
                                                        <a href="" title=""><?php echo str_repeat("- - ", $cat['level']) . $cat['product_cat_name'] ?></a>
                                                    </div>
                                        ...
                                        foreach ($list_product_cat as $cat_son) {
                                            if ($cat_son['level'] == 1 && $cat_son['parent_id'] == $cat['product_cat_id']) {
                                                $temp++;
                                            ?>
                                                <tr>
                                                    <td><input type="checkbox" name="checkItem" class="checkItem"></td>
                                                    ...
                                                    <td class="clearfix">
                                                        <div class="tb-title fl-left">
                                                            <a href="" title=""><?php echo str_repeat("- - ", $cat_son['level']) . $cat_son['product_cat_name'] ?></a>
                                                        </div>
                                                        <ul class="list-operation fl-right">
                                                            <li><a href="?mod=products&controller=productCat&action=update&id=<?php echo $cat_son['product_cat_id'] ?>" title="Sửa" class="edit"><i class="fa fa-pencil" aria-hidden="true"></i></a></li>
                                                            <li><a href="" title="Xóa"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
                                                        </ul>
                                                    </td>
